...
// Alternative endpoint for checkout by booking ID
router.get('/checkout/booking/:bookingId', auth, authorize(['FRONT DESK', 'ACCOUNTS', 'ADMIN']), checkoutController.getCheckoutByBooking);
