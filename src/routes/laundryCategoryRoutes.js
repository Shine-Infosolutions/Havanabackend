...
// Category Management
router.post('/', auth, authorize(['ADMIN', 'GM']), categoryController.createCategory);
router.get('/', auth, authorize(['ADMIN', 'GM', 'ACCOUNTS', 'STAFF', 'FRONT DESK']), categoryController.getAllCategories);
router.get('/:id', auth, authorize(['ADMIN', 'GM', 'ACCOUNTS', 'STAFF', 'FRONT DESK']), categoryController.getCategoryById);
router.put('/:id', auth, authorize(['ADMIN', 'GM']), categoryController.updateCategory);
